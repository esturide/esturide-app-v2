...
function SimpleCarPresentation({
  ...
  return (
    <div
      className={
        'bg-gradient-animated-clear flex flex-col items-start gap-2 bg-white rounded-lg px-6 py-4 shadow-lg hover:shadow-2xl transition-shadow duration-300 ease-in-out'
      }
    >
