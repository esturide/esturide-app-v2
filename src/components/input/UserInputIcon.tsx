...
const UserInputIcon: React.FC<Props> = ({
  ...
  return (
    <InputContainer>
      ...
      >
        <Icon className="col-start-1 row-start-1 h-5 w-5 self-center justify-self-end text-gray-400" />
      </button>
    </InputContainer>
  );
};
